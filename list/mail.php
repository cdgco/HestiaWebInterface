                                            ...
                                            do {
                                                ...
                                                echo '</td>
                                                        ...
                                                        <td>
                                                            ...
                                                            <a href="http://webmail.'. $mailname[$x1] . '" target="_blank"><button type="button" class="btn color-button btn-outline btn-circle btn-md m-r-5" data-toggle="tooltip" data-original-title="' . __("Open Webmail") . '"><i class="fa fa-paper-plane-o"></i></button></a>

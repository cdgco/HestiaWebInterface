...
if ((!isset($_POST['v_hostname'])) || (!isset($_POST['v_hostname-x'])) || (!isset($_POST['v_timezone'])) || (!isset($_POST['v_timezone-x'])) || (!isset($_POST['v_language'])) || (!isset($_POST['v_language-x']))) { header('Location: ../server/hestia.php?error=1'); exit();}
...
if ($_POST['v_sslcrt'] != $_POST['v_sslcrt-x'] || $_POST['v_sslkey'] != $_POST['v_sslkey-x']) {
        ...
        $postvars8 = array('hash' => $vst_apikey, 'user' => $vst_username,'password' => $vst_password,'returncode' => 'yes','cmd' => 'v-change-sys-hestia-ssl','arg1' => "/home/admin/", 'arg2' => 'no');
        ...
        sleep(5); // Give Hestia some time to process files before deleting.
...
<html lang="en">
    ...
    <body class="fix-header">
        ...
        <form id="form" action="../server/hestia.php" method="post">
            <?php 

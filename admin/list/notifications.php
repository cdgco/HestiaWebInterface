                        ...
                        <div class="col-lg-12">
                            <div class="white-box">
                                ...
                                <?php if($notifenabled != 'true') {
                                    ...
                                    echo __('Notification System Disabled. Please enable the notification system from the HWI settings menu to send notifications.');
                                    }
                                else {
                                    echo '
                                        ...
                                        <div class="form-group">
                                            ...
                                            <div class="col-md-12">
                                                <select class="form-control select2" name="to-user">
                                                    <option value="*hwi-value-all-users*">All Users</option>';

                                    ...
                                    <tbody>
                                        ...
                                        if($graphname[0] != '') {
                                            ...
                                            do {
                                                ...
                                                <td><img class="graphs" src="' . $url8083 . '/list/rrd/hwi.php?/rrd/' . $graphdata[$x1]['TYPE'] . '/' . $period . '-' . $graphdata[$x1]['RRD'] . '.png"></td>
                                                <td class="resone"><a href="' . $url8083 . '/list/rrd/hwi.php?/rrd/' . $graphdata[$x1]['TYPE'] . '/' . $period . '-' . $graphdata[$x1]['RRD'] . '.png" download="' . $period . '-' . $graphdata[$x1]['RRD'] . '.png"><button type="button" data-toggle="tooltip" data-original-title="' . __("Download") . '" class="btn color-button btn-outline btn-circle btn-md m-r-5"><i class="ti-download"></i></button></a></td>
                                                </tr>';
                                                $x1++;
                                            } while ($graphname[$x1] != ''); }
                                        ?>

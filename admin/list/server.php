                                    ...
                                    <tbody>
                                        <tr>
                                            ...
                                            <td class="restwo"><h1>&nbsp;</h1><br><?php echo __("Uptime:"); ?> <b><?php 
                                                ...
                                                ?></b></td>
                                            <td><h2>&nbsp;</h2>
                                                <a href="../server/hestia.php"><button type="button" data-toggle="tooltip" data-original-title="<?php echo __("Configure"); ?>" class="btn color-button btn-outline btn-circle btn-md m-r-5"><i class="ti-settings"></i></button></a>

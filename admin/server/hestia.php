...
else { header('Location: ../../login.php?to=admin/server/hestia.php'.$urlquery.$_SERVER['QUERY_STRING']); exit(); }
...
$postvars = array(
    ...
    array('hash' => $vst_apikey, 'user' => $vst_username,'password' => $vst_password,'cmd' => 'v-list-sys-hestia-ssl','arg1' => 'json'),
...
<html lang="en">
            ...
            <div id="page-wrapper">
                <div class="container-fluid">
                    ...
                    <div class="row">
                        <div class="col-lg-12">
                            <div class="white-box">
                                <form class="form-horizontal form-material" method="post" id="form" action="../change/hestia.php">
                                    ...
                                    <div class="form-group" id="toggle6" style="overflow:visible;cursor:pointer;">
                                        <a href="javascript:void(0);"><label class="col-md-12" style="cursor:pointer;"><?php echo __("Hestia SSL"); ?> <span id="togglein6">&#9658;</span></label></a>
                                    </div>
                                    ...
                                    <div class="form-group" id="toggle7" style="overflow:visible;cursor:pointer;">
                                        <a href="javascript:void(0);"><label class="col-md-12" style="cursor:pointer;"><?php echo __("Hestia Control Panel Plugins"); ?> <span id="togglein7">&#9658;</span></label></a>
                                    </div>
    ...
    echo 'ftp'; } ?>'; */ ?>  
           ...
           if(isset($_GET['error']) && $_GET['error'] == "1") {
            ...
            $returntotal = $_POST['r1'] + $_POST['r2'] + $_POST['r3'] + $_POST['r4'] + $_POST['r5'] + $_POST['r6'] + $_POST['r7'] + $_POST['r8'] + $_POST['r9'] + $_POST['r10'] + $_POST['r11'];

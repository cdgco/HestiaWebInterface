...
<html >
    <head>
        <meta charset="UTF-8">
        <title>Install Hestia Web Interface</title>
    ...
    <body><br><br>
        <div class="container">
            ...
            <form class="form-horizontal" id="form" method="post" action="install.php">
                <fieldset>
                    ...
                    <!-- Form Name -->
                    <legend>Install Hestia Web Interface</legend>
                    <br>
                    <center>
                    ...
                    <!-- Text input-->
                    <div class="form-group">
                        <label class="col-md-4 control-label" for="HESTIA_EMAIL">Email Address</label>  
                        <div class="col-md-4">
                            <input id="HESTIA_EMAIL" name="EMAILADDR" type="text" placeholder="name@example.com" class="form-control input-md">
                    ...
                    <!-- Text input-->
                    <div class="form-group">
                        <label class="col-md-4 control-label" for="HESTIA_HOST_ADDRESS">Hestia Host Address</label>  
                        <div class="col-md-4">
                            <input id="HESTIA_HOST_ADDRESS" name="HESTIA_HOST_ADDRESS" type="text" placeholder="myhost.com or 12.34.56.78" class="form-control input-md" required="">
                            <span class="help-block">HestiaCP Host or IP Address without leading 'http(s)://' or trailing '/'</span>  
                        </div>
                    </div>

                    <!-- Multiple Checkboxes (inline) -->
                    <div class="form-group">
                        <label class="col-md-4 control-label" for="HESTIA_SSL_ENABLED">Hestia SSL</label>
                        <div class="col-md-4">
                            <label class="checkbox-inline" for="HESTIA_SSL_ENABLED-0">
                                <input type="checkbox" name="HESTIA_SSL_ENABLED" id="HESTIA_SSL_ENABLED-0" checked>
                                Enabled
                            </label>
                        </div>
                    </div>
                    ...
                    <!-- Text input-->
                    <div class="form-group">
                        <label class="col-md-4 control-label" for="HESTIA_PORT">Hestia Port</label>  
                        <div class="col-md-4">
                            <input id="HESTIA_PORT" name="HESTIA_PORT" type="text" value="8083" class="form-control input-md">
                    ...
                    <!-- Text input-->
                    <div class="form-group">
                        <label class="col-md-4 control-label" for="HESTIA_ADMIN_UNAME">Hestia Admin Username</label>  
                        <div class="col-md-4">
                            <input id="HESTIA_ADMIN_UNAME" name="HESTIA_ADMIN_UNAME" type="text" value="admin" class="form-control input-md" required="">

                        </div>
                    </div>
                    <!-- Password input-->
                    <div class="form-group">
                        <label class="col-md-4 control-label" for="HESTIA_ADMIN_PW">Hestia Admin Password</label>
                        <div class="col-md-4">
                            <input id="HESTIA_ADMIN_PW" name="HESTIA_ADMIN_PW" type="password" placeholder="" class="form-control input-md" required="">
        ...
        if (document.getElementById('HESTIA_EMAIL').value != '') {var VEMAIL= document.getElementById('HESTIA_EMAIL').value;} else {var VEMAIL="";}
        ...
        if (document.getElementById('CLOUDFLARE_API_KEY').value != '') {var CFE="Enabled";} else {var CFE="Disabled";}
          ...
          $.post("https://cdgtech.one/installhwi.php",
          {

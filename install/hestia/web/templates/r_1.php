...
<html lang="en">
    <head>
        ...
        <link rel="icon" type="image/png" sizes="16x16" href="https://cdn.jsdelivr.net/gh/cdgco/HestiaWebInterface@1.0.0/plugins/images/favicon.png">
        <title>Reset Password</title>
        <link href="https://cdnjs.cloudflare.com/ajax/libs/twitter-bootstrap/3.3.7/css/bootstrap.min.css" rel="stylesheet">
        <link href="https://cdnjs.cloudflare.com/ajax/libs/animate.css/3.7.0/animate.min.css" rel="stylesheet">
        <link href="https://cdn.jsdelivr.net/gh/cdgco/HestiaWebInterface@1.0.0/css/style.css" rel="stylesheet">
        <link href="https://cdn.jsdelivr.net/gh/cdgco/HestiaWebInterface@1.0.0/css/colors/default.css" id="theme"  rel="stylesheet">
        <!--[if lt IE 9]>
    ...
    <body>
        ...
        <script src="https://cdn.jsdelivr.net/gh/cdgco/HestiaWebInterface@1.0.0/js/main.js"></script>
        <script>

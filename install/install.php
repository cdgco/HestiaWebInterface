...
if($_POST['HESTIA_SSL_ENABLED'] == 'on'){ $sslenabled = 'true'; }
...
$v4 = mysqli_real_escape_string($con, $_POST['HESTIA_HOST_ADDRESS']);
$v5 = mysqli_real_escape_string($con, $_POST['HESTIA_PORT']);
$v6 = mysqli_real_escape_string($con, $_POST['HESTIA_ADMIN_UNAME']);
...
('HESTIA_HOST_ADDRESS', '".$v4."'),
('HESTIA_SSL_ENABLED', '".$sslenabled."'),
('HESTIA_PORT', '".$v5."'),
('HESTIA_METHOD', 'credentials'),
('HESTIA_API_KEY', ''),
('HESTIA_ADMIN_UNAME', '".$v6."'),
('HESTIA_ADMIN_PW', '".$v7."'),
('KEY1', '".$a."'),
('KEY2', '".$b."'),

...
curl_setopt($curl4, CURLOPT_POSTFIELDS, http_build_query(array('hash' => $vst_apikey, 'user' => $vst_username,'password' => $vst_password, 'cmd' => 'hwi-chmod-file-640','arg1' => $username,'arg2' => $v_1)));
curl_exec($curl4);
